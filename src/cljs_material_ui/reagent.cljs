...
(def filled-input (r/adapt-react-class (aget js/MaterialUI "FilledInput")))
...
(def no-ssr (r/adapt-react-class (aget js/MaterialUI "NoSsr")))
(def outlined-input (r/adapt-react-class (aget js/MaterialUI "OutlinedInput")))
